...
class passaro:
    ...
    def desenhar(self, tela):
        ...
        pos_centero_imagem = self.imagem.get.rect(topleft=(self.x, self.y)).center 
        retangulo = imagem_rotacionada.get_rect(center=pos_centero_imagem)
...
def desenhar_tela(tela, passaros, canos, chao, pontos):
    ...
    texto = FONTES_PONTOS.render(f'Pontução: {pontos}', 1, (255, 255, 255))
